...
CREATE TABLE IF NOT EXISTS page (id INT(11) AUTO_INCREMENT not null,category VARCHAR (32) NOT NULL DEFAULT '',filename varchar (128) NOT NULL DEFAULT '', parent_id smallint (5) NOT NULL DEFAULT '0', page_name varchar (150) NOT NULL DEFAULT '', title VARCHAR (128) DEFAULT '', content longtext, keywords varchar (255) NOT NULL DEFAULT '', description varchar (255) NOT NULL DEFAULT '', sort INT (8) NOT NULL DEFAULT '0', pv int(10) NOT NULL DEFAULT '0', image varchar (5120) NOT NULL DEFAULT '', banner varchar (5120) NOT NULL DEFAULT '', PRIMARY KEY (id))ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS product ( id INT(11) AUTO_INCREMENT, cat_id smallint (5) NOT NULL DEFAULT '0', filename varchar (128) NOT NULL DEFAULT '', defined TEXT, name varchar (150) NOT NULL DEFAULT '', price decimal(10, 4) NOT NULL DEFAULT '0.00', weight decimal(10, 4) NOT NULL DEFAULT '0.00', sn varchar(32) DEFAULT '', title VARCHAR (128) DEFAULT '', keywords varchar (255) NOT NULL DEFAULT '', description varchar (255) NOT NULL DEFAULT '', content longtext, image varchar (5120) NOT NULL DEFAULT '', first_time int (10) NOT NULL DEFAULT '0', edit_time int (10) NOT NULL DEFAULT '0', sort tinyint (1) NOT NULL DEFAULT '0', ext1 varchar (255) NOT NULL DEFAULT '', ext2 varchar (255) NOT NULL DEFAULT '', ext3 varchar (255) NOT NULL DEFAULT '', ext4 varchar (255) NOT NULL DEFAULT '', ext5 varchar (255) NOT NULL DEFAULT '', ext6 varchar (255) NOT NULL DEFAULT '', ext7 varchar (255) NOT NULL DEFAULT '', ext8 varchar (255) NOT NULL DEFAULT '', ext9 varchar (255) NOT NULL DEFAULT '', ext10 varchar (255) NOT NULL DEFAULT '', ext11 varchar (255) NOT NULL DEFAULT '', ext12 varchar (255) NOT NULL DEFAULT '', ext13 varchar (255) NOT NULL DEFAULT '', ext14 varchar (255) NOT NULL DEFAULT '', ext15 varchar (255) NOT NULL DEFAULT '', pv int(10) NOT NULL DEFAULT '0', tag varchar(255) NOT NULL default '', banner varchar (5120) NOT NULL DEFAULT '', PRIMARY KEY (id))ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS product_category ( cat_id INT(11) AUTO_INCREMENT, category VARCHAR (32) NOT NULL DEFAULT '', parent_id smallint (5) NOT NULL DEFAULT '0', unique_id varchar (30) NOT NULL DEFAULT '', cat_name varchar (32) NOT NULL DEFAULT '', title VARCHAR (128) DEFAULT '', keywords varchar (255) NOT NULL DEFAULT '', description varchar (255) NOT NULL DEFAULT '', content TEXT, sort tinyint (1) NOT NULL DEFAULT '50', image varchar (5120) NOT NULL DEFAULT '', banner varchar (5120) NOT NULL DEFAULT '', PRIMARY KEY(cat_id), UNIQUE KEY(unique_id))ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS mailbox ( id INT(11) AUTO_INCREMENT, mail_title VARCHAR (128) NOT NULL DEFAULT '', mail_body TEXT, mail_from VARCHAR (64) NOT NULL DEFAULT '', mail_to VARCHAR (64) NOT NULL DEFAULT '', user_ip VARCHAR (16) NOT NULL DEFAULT '0.0.0.0', add_time INT (11) NOT NULL DEFAULT '0', send_time INT (11) NOT NULL DEFAULT '0', err_count int (11) NOT NULL DEFAULT '0', sending TINYINT(1) DEFAULT '0', PRIMARY KEY(id))ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS article ( id INT(11) AUTO_INCREMENT, cat_id smallint (5) NOT NULL DEFAULT '0', filename varchar (128) NOT NULL DEFAULT '', defined TEXT, title varchar (150) NOT NULL DEFAULT '', keywords varchar (255) NOT NULL DEFAULT '', description varchar (255) NOT NULL DEFAULT '', content longtext, image varchar (5120) NOT NULL DEFAULT '', add_time int(11) NOT NULL DEFAULT '0', edit_time int (10) NOT NULL DEFAULT '0', click smallint (6) NOT NULL DEFAULT '0', sort tinyint (1) NOT NULL DEFAULT '0', pv int(10) NOT NULL DEFAULT '0', tag varchar(255) NOT NULL default '', banner varchar (5120) NOT NULL DEFAULT '', PRIMARY KEY(id))ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS config ( name varchar (80) NOT NULL, `value` TEXT, `type` varchar (10) NOT NULL DEFAULT '', tab varchar (32) NOT NULL DEFAULT 'main', box varchar (255) NOT NULL DEFAULT '', sort tinyint (3) NOT NULL DEFAULT '1', PRIMARY KEY (`name`))ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT IGNORE INTO config (name, value, type, tab, box, sort) VALUES ('tpl_cache_time', '86400000', 'text', 'cacheing', '', 2);
...
CREATE TABLE IF NOT EXISTS member_orders_status(orders_id int(11) not null default '0', status TINYINT(1) not null default '0', notes varchar(128) not null default '', atime int(11) NOT NULL DEFAULT '0')ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS member_msg(id int(11) not null AUTO_INCREMENT, user_id int(11) NOT NULL DEFAULT '0', title varchar(64) not null default '', content TEXT, atime int(11) NOT NULL DEFAULT '0', unique key(user_id, title),PRIMARY KEY(id))ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS member_msg_reply(id int(11) not null AUTO_INCREMENT, msg_id int(11) NOT NULL DEFAULT '0', user_id int(11) NOT NULL DEFAULT '0', content TEXT, atime int(11) NOT NULL DEFAULT '0', PRIMARY KEY(id))ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS member_orders_invoice (orders_id int(11) NOT NULL DEFAULT '0', orders_info text, atime int(11) NOT NULL DEFAULT '0', PRIMARY KEY (`orders_id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS admin (user_id int(11) NOT NULL AUTO_INCREMENT, user_name varchar(60) NOT NULL DEFAULT '', email varchar(60) NOT NULL DEFAULT '', password varchar(32) NOT NULL DEFAULT '', action_list TEXT, add_time int(11) NOT NULL DEFAULT '0', last_login int(11) NOT NULL DEFAULT '0', last_ip varchar(15) NOT NULL DEFAULT '', PRIMARY KEY(user_id),unique key(user_name)) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT IGNORE INTO admin (user_id, user_name, email, password, action_list, add_time, last_login, last_ip) VALUES (1, 'admin', '', 'e10adc3949ba59abbe56e057f20f883e', 'all', 1467365040, 1534867579, '192.168.80.1');
