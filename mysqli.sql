...
CREATE TABLE IF NOT EXISTS product ( id INT(11) AUTO_INCREMENT, cat_id smallint (5) NOT NULL DEFAULT '0', filename varchar (128) NOT NULL DEFAULT '', name varchar (150) NOT NULL DEFAULT '', price decimal(10, 4) NOT NULL DEFAULT '0.00', weight decimal(10, 4) NOT NULL DEFAULT '0.00', defined varchar(32) DEFAULT '', title VARCHAR (128) DEFAULT '', keywords varchar (255) NOT NULL DEFAULT '', description varchar (255) NOT NULL DEFAULT '', content longtext, image varchar (5120) NOT NULL DEFAULT '', edit_time int (10) NOT NULL DEFAULT '0', sort tinyint (1) NOT NULL DEFAULT '0', ext1 varchar (255) NOT NULL DEFAULT '', ext2 varchar (255) NOT NULL DEFAULT '', ext3 varchar (255) NOT NULL DEFAULT '', ext4 varchar (255) NOT NULL DEFAULT '', ext5 varchar (255) NOT NULL DEFAULT '', ext6 varchar (255) NOT NULL DEFAULT '', ext7 varchar (255) NOT NULL DEFAULT '', ext8 varchar (255) NOT NULL DEFAULT '', ext9 varchar (255) NOT NULL DEFAULT '', ext10 varchar (255) NOT NULL DEFAULT '', ext11 varchar (255) NOT NULL DEFAULT '', ext12 varchar (255) NOT NULL DEFAULT '', ext13 varchar (255) NOT NULL DEFAULT '', ext14 varchar (255) NOT NULL DEFAULT '', ext15 varchar (255) NOT NULL DEFAULT '', pv int(10) NOT NULL DEFAULT '0', PRIMARY KEY (id))ENGINE=MyISAM DEFAULT CHARSET=utf8;
