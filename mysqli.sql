...
CREATE TABLE IF NOT EXISTS article ( id INT(11) AUTO_INCREMENT, cat_id smallint (5) NOT NULL DEFAULT '0', filename varchar (32) NOT NULL DEFAULT '', defined TEXT, title varchar (150) NOT NULL DEFAULT '', keywords varchar (255) NOT NULL DEFAULT '', description varchar (255) NOT NULL DEFAULT '', content longtext, image varchar (5120) NOT NULL DEFAULT '', add_time int(11) NOT NULL DEFAULT '0', edit_time int (10) NOT NULL DEFAULT '0', click smallint (6) NOT NULL DEFAULT '0', sort tinyint (1) NOT NULL DEFAULT '0', pv int(10) NOT NULL DEFAULT '0', PRIMARY KEY(id))ENGINE=MyISAM DEFAULT CHARSET=utf8;
