...
CREATE TABLE IF NOT EXISTS product_category ( cat_id INT(11) AUTO_INCREMENT, category VARCHAR (32) NOT NULL DEFAULT '', parent_id smallint (5) NOT NULL DEFAULT '0', unique_id varchar (30) NOT NULL DEFAULT '', cat_name varchar (32) NOT NULL DEFAULT '', title VARCHAR (128) DEFAULT '', keywords varchar (255) NOT NULL DEFAULT '', description varchar (255) NOT NULL DEFAULT '', content TEXT, sort tinyint (1) NOT NULL DEFAULT '50', image varchar (5120) NOT NULL DEFAULT '', PRIMARY KEY(cat_id), UNIQUE KEY(unique_id))ENGINE=MyISAM DEFAULT CHARSET=utf8;
