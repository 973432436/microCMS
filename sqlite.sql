...
CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT, cat_id smallint (5) NOT NULL DEFAULT '0', filename varchar (128) NOT NULL DEFAULT '', defined TEXT, title varchar (150) NOT NULL DEFAULT '', keywords varchar (255) NOT NULL DEFAULT '', description varchar (255) NOT NULL DEFAULT '', content longtext, image varchar (5120) NOT NULL DEFAULT '', add_time INTEGER NOT NULL DEFAULT '0', edit_time INTEGER NOT NULL DEFAULT '0', click smallint (6) NOT NULL DEFAULT '0', sort tinyint (1) NOT NULL DEFAULT '0', pv INTEGER NOT NULL DEFAULT '0');
